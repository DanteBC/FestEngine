...
- Добавлена возможность перемотки трека целчком по прогресс-бару
...
- Добавлена возможность отправки POST запросов о действиях по программе (очень полезно для поддержания онлайн версии программы фестиваля)
- Добавлен простенький локальный API сервер для внешнего опроса текущего номера программы
- Добавлена темная тема (вместе с переездом на wxPython 4.3.1) 
